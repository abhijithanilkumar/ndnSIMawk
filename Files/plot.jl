...
data1 = readtable("../Script/fifo_benchmark.txt", separator=' ')
...
p=Gadfly.plot([layer(data1, y=algos[i],x="CacheSize", Geom.line, Theme(default_color=cols[i],line_width=.8mm)) for i=1:n]..., Guide.XLabel("Cache Size"),
...
draw(SVGJS("./graph_fifo.svg",15inch,12inch),p)
