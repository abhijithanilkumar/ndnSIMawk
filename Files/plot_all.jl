...
p=Gadfly.plot([layer(data1, y=algos[i],x="CacheSize", Geom.smooth, Theme(default_color=cols[i],line_width=.8mm,minor_label_font_size=100,key_label_font_size=20)) for i=1:n]..., Guide.XLabel("Cache Size"),
